...
function About() {
    return (
        <>
        <Grid container spacing={0} direction='column' alignContent='center' justify='center'style={{ minHeight: '100vh',paddingTop:'30px' }}>
        <Card style={{ width:'80%'}} >
        <Container maxWidth='sm'>
            <img style={{paddingTop: '5px', borderRadius:'50%', display: 'block', marginLeft:'auto', marginRight:'auto', width: '25%'}} src = 'avatar.jpg' alt='avatar image'></img>
        </Container>
        <Container maxWidth='md' style={{paddingTop:'20px'}}>
            <Typography variant='body1' align='center' sx={{fontSize:{lg:20, md:18, sm:15, xs:10}}}paragraph >
