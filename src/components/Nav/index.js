              ...
              <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
                ...
                >
                    <MenuItem onClick={handleCloseNavMenu}>
                      <Typography onClick={()=> setCurrentPage('About Me')} textAlign="center">About Me</Typography>
                    </MenuItem>
                    <MenuItem onClick={handleCloseNavMenu}>
                      <Typography onClick={()=> setCurrentPage('Contact Me')} textAlign="center">Contact</Typography>
                    </MenuItem>
                    <MenuItem onClick={handleCloseNavMenu}>
